...
datRes<- datRes%>%
  dplyr::mutate(
      ...
      experiment= case_when(
        adapteddesigntreatment== "Control"~ 0,
        adapteddesigntreatment!= "Control"~ 1
      )
    )
...
t.test(vac_covid_d12~ telephone, data= datRes)
t.test(nb_satis_d12~ telephone, data= datRes)
t.test(nb_reputation_d12~ telephone, data= datRes)
